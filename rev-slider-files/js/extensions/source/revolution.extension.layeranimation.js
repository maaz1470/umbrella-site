...
jQuery.extend(true,_R, {
	...
	********************************************/	
	prepareSingleCaption : function(obj) {
		...
		var tpcapindex = _nc.css("z-index.html");
	...
	endMoveCaption : function(obj) {
		...
		if (!nc.static || (obj.currentslide>=nc.removeonslide) || (obj.currentslide<nc.showonslide)) {		
			...
			if (_.visibleelement===true)
				_R.createFrameOnTimeline({caption:obj.caption, timeline : nc.outnow, label:"outnow", frameindex : obj.caption.data("outframeindex.html"), opt:obj.opt, fromcurrentstate:true}).play();	 		
		}		
